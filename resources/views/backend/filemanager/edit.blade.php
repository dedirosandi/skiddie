...
@section('container')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            <form action="/dashboard/filemanager/{{ $fileManager->id }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input id="x" type="hidden" name="file_description"
                        value="{{ old('file_description', $fileManager->file_description) }}">
