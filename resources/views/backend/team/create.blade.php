        ...
        <div class="pd-20 card-box mb-30">
            <form action="/dashboard/team" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="username" placeholder="johnnybrown" />
                </div>
                <div class="form-group">
                    <label>As a</label>
                    <input class="form-control" type="text" name="as" placeholder="Full Stack Web Developer" />
                </div>
                <div class="form-group">
                    <label>Email</label>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="linkedin" placeholder="Linkedin" type="url" />
                </div>
                <div class="form-group">
