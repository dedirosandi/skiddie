                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false"> <img
                                    src="profile_pictures/{{ auth()->user()->profile_picture }}" alt="user-img"
...
<script src="assets-dashboard/js/plugin/chartist/chartist.min.js"></script>
<script src="assets-dashboard/js/plugin/chartist/plugin/chartist-plugin-tooltip.min.js"></script>
...
<script src="assets-dashboard/js/plugin/jquery-mapael/jquery.mapael.min.js"></script>
<script src="assets-dashboard/js/plugin/jquery-mapael/maps/world_countries.min.js"></script>
...
<script src="assets-dashboard/js/ready.min.js"></script>
